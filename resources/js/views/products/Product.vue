    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <b-link :to="{ name: 'products.add' }" class="btn btn-dark btn-sm btn-flat">Tambah</b-link>
            ...
            <div class="panel-body">
                <b-table striped hover dark :items="products.data" :fields="fields" show-empty responsive="sm" >
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p v-if="products.data"><i class="fa fa-bars"></i> {{ products.data.length }} item dari {{ products.total }} total data</p>
                    </div>
                    <div class="col-md-6">
                        <div class="pull-right">
                            <b-pagination
