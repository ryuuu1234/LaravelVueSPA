...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])("stokMitra", {
    ...
    statusPacking: function statusPacking() {
      var packing = this.orders.packing; // if

      return packing;
    },
    statusSupplier: function statusSupplier() {
      var supplier = this.orders.supplier; // if
    ...
    beforeFinish: function beforeFinish() {
  ...
  methods: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])("order", ["getOrderById", "updateStatusOrder"]), {}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])("packing", ["getPackingAll"]), {}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapActions"])("supplier", ["getSupplierAll"]), {
    ...
    updateStatusToTerkirim: function updateStatusToTerkirim() {
      var _this3 = this;
    ...
    _c("div", { staticClass: "progress-order" }, [
      ...
      _vm.step == 2
        ? _c("section", [
            ...
            _vm._v(" "),
            !_vm.statusPacking
              ? _c("p", [_vm._v("Belum ada yang ditugaskan ")])
              : _vm.statusPacking.status == 0
              ? _c("p", [_vm._v("Packing sedang dalam proses ")])
              : _vm.statusPacking.status == 1
              ? _c("p", [_vm._v("Packing sudah selesai ")])
              : _vm.statusPacking.status == 2
              ? _c("p", [
                  _vm._v("Packing dibatalkan, silahkan pilih packing yag lain ")
                ])
              : _vm._e()
          ])
        : _vm._e(),
      ...
      _vm.step == 3
        ? _c("section", [
            ...
            _c("div", [
              ...
              _vm._v(" "),
              _vm.statusSupplier && _vm.statusSupplier.status == 1
                ? _c(
                    "button",
                    {
                      staticClass: "btn btn-info btn-xsm",
            ...
            _c("div", [
              !_vm.statusSupplier
                ? _c("p", [_vm._v("Belum ada yang ditugaskan ")])
                : _vm.statusSupplier.status == 0
                ? _c("p", [
                    _vm._v(" Barang sedang dalam proses pengantaran ke Mitra  ")
                  ])
                : _vm.statusSupplier.status == 1
                ? _c("p", [_vm._v(" Barang sudah sampai ke Mitra ")])
                : _vm.statusSupplier.status == 2
                ? _c("p", [
                    _vm._v(
                      "Supplier dibatalkan, silahkan pilih Supplier yag lain "
                    )
                  ])
                : _vm._e()
            ])
      ...
      _vm.step == 4
        ? _c("section", [
            _vm._m(7),
            _vm._v(" "),
            _c("p", [_vm._v("Menunggu Konfirmasi barang dari Mitra")]),
            _vm._v(" "),
            _c("br"),
            _vm._v(" "),
            _c("div", [
              _vm.order.status_id == 5
                ? _c(
                    "button",
                    {
                      staticClass: "btn btn-info btn-xsm",
                      on: { click: _vm.kirimLagi }
                    },
                    [_vm._v("Kirim ulang notifikasi pada mitra")]
                  )
                : _vm._e()
            ]),
            _vm._v(" "),
            _c("div", [
              _vm.order.status_id == 5
                ? _c("p", [
                    _vm._v("Barang sudah sampai ke Mitra yang bersangkutan ")
                  ])
                : _vm._e(),
              _vm._v(" "),
              _vm.order.status_id == 6
                ? _c("p", [_vm._v("Mitra sudah mengkonfirmasi pengiriman ")])
                : _vm._e()
            ])
          ])
        : _vm._e()
      ...
      _vm.step != _vm.totalStep
        ? _c(
            "button",
            {
              ...
              attrs: { disabled: _vm.nextDisable },
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("h6", [_c("u", [_vm._v("Order Sudah sampai ke Mitra")])])
  }
]
